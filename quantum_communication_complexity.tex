    ...
    \section{Communication Complexity}
        ...
        \begin{figure}[t]
            ...
            \begin{tikzpicture}[->, draw, node distance=2cm]
                ...
                \path ([yshift=-1ex]Alice.east) edge ([yshift=-1ex]Bob.west);
            \end{tikzpicture}
            \caption{An example of communication complexity, with Alice and Bob sending a total of three messages between each other.}
        \end{figure}
        ...
        \begin{figure}[t]
            ...
            \end{tikzpicture}
            \caption{An example of one-way communication complexity. All of the communication is sent in a single message from Alice to Bob.}
        \end{figure}
