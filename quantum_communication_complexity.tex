...
\begin{document}
    ...
    \section{Functions}
        ...
        \begin{codebox}
            ...
            \zi \const{Bob's output:} $1$ iff $x = y$, $0$ otherwise.
            \li Alice starts computation in the $|0\rangle^{\otimes \log n}$ state and applies $U_xH^{\otimes \log n}$ to get the state $|\psi\rangle = \sum_{i=0}^{n-1}(-1)^{x_i}|i\rangle$.
